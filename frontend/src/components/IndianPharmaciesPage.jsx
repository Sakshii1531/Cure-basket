    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#006D6D] to-[#004D4D] text-white pt-12 pb-16 px-4 md:px-8 text-center relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto space-y-3 relative z-10">
          <h1 className="text-[32px] md:text-[44px] font-bold tracking-tight">About Indian Pharmacies</h1>
          <p className="text-[14px] md:text-[16px] text-[#CFF4F4] max-w-xl mx-auto font-medium">
            Learn why Indian pharmacies are the worldwide leader in safe, high-quality, and affordable generic medications.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <div className="space-y-4">
            ...
            <p className="text-[14px] md:text-[15.5px] text-gray-600 font-medium leading-relaxed text-justify">
              India produces over 20% of the world’s generic drug supply by volume. With robust manufacturing facilities certified by top international drug regulatory bodies including the US FDA, UK MHRA, and WHO, generic formulations originating from India meet identical global therapeutic efficacy metrics.
            </p>
          </div>
          <div className="space-y-4">
            <h2 className="text-[20px] md:text-[26px] font-bold text-gray-900 leading-tight">Why is Sourcing So Economical?</h2>
            <p className="text-[14px] md:text-[15.5px] text-gray-600 font-medium leading-relaxed text-justify">
              Indian pharmacies offer lower costs not by compromising on active chemical compounds, but due to highly competitive localized production costs, low scientific research overheads for generic compounds, and strong patent rules designed to encourage accessible general public healthcare.
            </p>
          </div>
        </div>
