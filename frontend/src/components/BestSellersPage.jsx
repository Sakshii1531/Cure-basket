...
function SkeletonCard() {
  return (
    <div className="bg-white rounded-[16px] md:rounded-[24px] border border-gray-200 p-2.5 md:px-4 md:py-3 animate-pulse">
      <div className="w-full h-20 md:h-44 bg-gray-100 rounded-xl mb-2 md:mb-4" />
