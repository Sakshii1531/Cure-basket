      ...
      <div className="max-w-[1250px] mx-auto bg-[#fff8f0] rounded-[24px] p-8 md:p-10 flex flex-col md:flex-row items-center relative overflow-hidden">
        ...
        <div className="flex-1 z-10">
          <h1 className="text-[28px] md:text-[40px] font-bold leading-tight">
            <span className="text-[#FBB03B]">Express</span><br />
            <span className="text-[#006D6D]">Delivery in 15 Mins</span>
          </h1>
          <p className="text-[14px] md:text-[16px] text-gray-700 mt-4 max-w-[400px]">
            Running out of essentials? Get them delivered to your doorstep in the blink of an eye.
          </p>
          ...
          <div className="mt-8 flex flex-col md:flex-row items-center gap-4">
            ...
            <span className="text-[#FBB03B] font-semibold text-[14px]">No minimum order value!</span>
          </div>
        </div>
