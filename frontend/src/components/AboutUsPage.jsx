    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative bg-gradient-to-r from-[#006D6D] to-[#004D4D] text-white pt-12 pb-16 px-4 md:px-8 text-center overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto relative z-10 space-y-4">
          <h1 className="text-[32px] md:text-[48px] font-bold tracking-tight">About CureBasket</h1>
          <p className="text-[15px] md:text-[18px] text-[#CFF4F4] max-w-2xl mx-auto font-medium">
            Your trusted global partner for high-quality, affordable healthcare and medicines delivered right to your doorstep.
          </p>
        </div>
      </div>
            ...
            {[
              {
                ...
                description: "We source medications exclusively from WHO-GMP certified suppliers and reputable manufacturers, ensuring absolute safety.",
                icon: (
              ...
              },
              {
                ...
                description: "Your health records, order history, and personal details are encrypted and kept strictly confidential. Privacy is our top priority.",
                icon: (
                  <svg className="w-8 h-8 text-[#006D6D]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                description: "By sourcing quality generic alternatives directly, we offer deep discounts and up to 70% savings compared to standard offline drugstores.",
                icon: (
                  <svg className="w-8 h-8 text-[#006D6D]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
