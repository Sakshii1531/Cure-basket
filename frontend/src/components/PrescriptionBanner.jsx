      ...
      <div className="max-w-[1250px] mx-auto bg-[#f0fafa] rounded-[24px] p-3.5 md:p-5 flex flex-col md:flex-row items-center justify-between relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 md:gap-6 z-10 w-full md:w-auto">
          <div className="w-12 h-12 md:w-20 md:h-20 bg-white rounded-[16px] flex items-center justify-center shrink-0">
            <svg className="w-7 h-7 md:w-12 md:h-12 text-[#006D6D]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col">
            <h2 className="text-[14px] md:text-[17px] font-bold text-[#006D6D] leading-tight">
        ...
        {/* Right Side: Button */}
        <div className="mt-3 md:mt-0 z-10 md:mr-80 w-full md:w-auto">
          <button 
            onClick={() => {
              if (isLoggedIn) {
            ...
            className="w-full md:w-auto flex items-center justify-center gap-2 px-8 py-2 md:py-3 rounded-[12px] border-2 border-[#006D6D] border-dotted text-[#006D6D] font-bold text-[14px] md:text-[15px] hover:bg-[#006D6D] hover:text-white transition-all bg-transparent"
          >
