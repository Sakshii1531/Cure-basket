          ...
          <div className="flex-1 overflow-y-auto" style={{ background: '#f2f2ee' }}>
            {allCategoriesList.map((cat, i) => (
              <button
                ...
                className="w-full text-left px-5 py-3.5 text-[14px] font-medium text-gray-800 active:bg-gray-200 transition-colors"
          ...
          {mobileMenuItems.map((item, index) => (
            <div key={index}>
              <button
                ...
                className="w-full flex items-center justify-between px-5 py-3.75 text-left active:bg-[#e8e8e2] transition-colors"
              ...
              >
                ...
                {item.hasArrow && (
                  <div
                    className="w-7 h-7 rounded-full flex items-center justify-center transition-transform duration-300 bg-primary"
                    style={{
                ...
                <div style={{ background: '#e8e8e3', borderBottom: '1px solid #d8d8d2' }}>
                  {mensHealthSubItems.map((sub, si) => (
                    <button
                      ...
                      className="w-full text-left px-8 py-3.25 active:bg-[#ddddd8] transition-colors"
                      style={{ borderBottom: si !== mensHealthSubItems.length - 1 ? '1px solid #d0d0ca' : 'none' }}
                    >
                      <span
                        className="text-[12px] font-bold uppercase tracking-widest text-primary"
        ...
        <div className="p-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-11 pl-11 pr-4 bg-white border border-gray-200 rounded-xl outline-none focus:border-primary transition-all text-[13px]"
            />
          </div>
        </div>
