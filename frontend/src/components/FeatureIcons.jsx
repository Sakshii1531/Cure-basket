...
function FeatureIcons() {
  return (
    <section className="bg-white pt-0 pb-4 md:pb-6 px-4 md:px-12">
      <div className="max-w-[1250px] mx-auto border border-gray-100 rounded-[20px] shadow-[0_4px_25px_rgba(0,0,0,0.03)] bg-white p-3 md:p-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4 divide-y md:divide-y-0 md:divide-x divide-gray-100">
          {/* 100% Genuine */}
          <div className="flex items-center gap-4 px-2 md:px-4 py-1.5 md:py-0">
