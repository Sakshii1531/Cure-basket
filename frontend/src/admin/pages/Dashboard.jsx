        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-3">
              <Link
                to="/admin/medicines"
                className="w-full bg-secondary text-primary px-4 py-3 rounded-xl font-semibold text-sm hover:bg-secondary-soft transition-colors flex items-center justify-center gap-2"
              >
